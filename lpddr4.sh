...
if [ ${processor} == "8mn" ] ; then
sed -E -i \
 -e 's/^#include <asm\/arch\/ddr.h>/#include "lpddr4_timing_ch1.h"/' \
 -e 's/ dram_timing / dram_timing_ch1 /' \
$1
chnum=CH1
addrmap6_1gr0=0x07070707
addrmap6_2g=0x07070707
else
sed -E -i \
...
$1
chnum=CH2
addrmap6_1gr0=0x0f070707
addrmap6_2g=0x0f070707
fi
...
if [ "${mem}" == "1gr0" ] ; then
	echo 1gr0
	sed -E -i \
	 -e "s/0x5402c, 1 /0x5402c, ${chnum}_LPDDR4_CS /" \
	 -e "s/0x54012, 0x0110 /0x54012, 0x10 | (${chnum}_LPDDR4_CS << 8) /" \
	 -e "s/ DDRC_MSTR\(0\), 0xa1080020 / DDRC_MSTR\(0\), 0xa0080020 | \(${chnum}_LPDDR4_CS << 24\) /" \
	 -e "s/ DDRC_ADDRMAP0\(0\), 0x1f / DDRC_ADDRMAP0\(0\), ${chnum}_VAL_DDRC_ADDRMAP0 /" \
	 -e "s/ DDRC_ADDRMAP6\(0\), ${addrmap6_1gr0} / DDRC_ADDRMAP6\(0\), ${chnum}_VAL_DDRC_ADDRMAP6 /" \
	 -e "s/ DDRC_ADDRMAP7\(0\), 0x0f0f / DDRC_ADDRMAP7\(0\), ${chnum}_VAL_DDRC_ADDRMAP7 /" \
	 -e "s/ DDRC_RFSHTMG\(0\), 0x007a00b4 / DDRC_RFSHTMG\(0\), ${chnum}_VAL_DDRC_RFSHTMG /" \
	 -e "s/ DDRC_DRAMTMG14\(0\), 0xbc / DDRC_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_DRAMTMG14 /" \
	 -e "s/ DDRC_FREQ1_RFSHTMG\(0\), 0x000c0012 / DDRC_FREQ1_RFSHTMG\(0\), ${chnum}_VAL_DDRC_FREQ1_RFSHTMG /" \
	 -e "s/ DDRC_FREQ1_DRAMTMG14\(0\), 0x13 / DDRC_FREQ1_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_FREQ1_DRAMTMG14 /" \
	 -e "s/ DDRC_FREQ2_RFSHTMG\(0\), 0x00030005 / DDRC_FREQ2_RFSHTMG\(0\), ${chnum}_VAL_DDRC_FREQ2_RFSHTMG /" \
	 -e "s/ DDRC_FREQ2_DRAMTMG14\(0\), 5 / DDRC_FREQ2_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_FREQ2_DRAMTMG14 /" \
	$1
	match=1
fi
if [ "${mem}" == "2g" ] ; then
	echo 2g
	sed -E -i \
	 -e "s/0x5402c, 3 /0x5402c, ${chnum}_LPDDR4_CS /" \
	 -e "s/0x54012, 0x0310 /0x54012, 0x10 | (${chnum}_LPDDR4_CS << 8) /" \
	 -e "s/ DDRC_MSTR\(0\), 0xa3080020 / DDRC_MSTR\(0\), 0xa0080020 | \(${chnum}_LPDDR4_CS << 24\) /" \
	 -e "s/ DDRC_ADDRMAP0\(0\), 0x16 / DDRC_ADDRMAP0\(0\), ${chnum}_VAL_DDRC_ADDRMAP0 /" \
	 -e "s/ DDRC_ADDRMAP6\(0\), ${addrmap6_2g} / DDRC_ADDRMAP6\(0\), ${chnum}_VAL_DDRC_ADDRMAP6 /" \
	 -e "s/ DDRC_ADDRMAP7\(0\), 0x0f0f / DDRC_ADDRMAP7\(0\), ${chnum}_VAL_DDRC_ADDRMAP7 /" \
	 -e "s/ DDRC_RFSHTMG\(0\), 0x007a00b4 / DDRC_RFSHTMG\(0\), ${chnum}_VAL_DDRC_RFSHTMG /" \
	 -e "s/ DDRC_DRAMTMG14\(0\), 0xbc / DDRC_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_DRAMTMG14 /" \
	 -e "s/ DDRC_FREQ1_RFSHTMG\(0\), 0x000c0012 / DDRC_FREQ1_RFSHTMG\(0\), ${chnum}_VAL_DDRC_FREQ1_RFSHTMG /" \
...
if [ "${mem}" == "2gr0" ] ; then
	...
	sed -E -i \
	 ...
	 -e "s/ DDRC_MSTR\(0\), 0xa1080020 / DDRC_MSTR\(0\), 0xa0080020 | \(${chnum}_LPDDR4_CS << 24\) /" \
	 -e "s/ DDRC_ADDRMAP0\(0\), 0x1f / DDRC_ADDRMAP0\(0\), ${chnum}_VAL_DDRC_ADDRMAP0 /" \
	 -e "s/ DDRC_ADDRMAP6\(0\), 0x07070707 / DDRC_ADDRMAP6\(0\), ${chnum}_VAL_DDRC_ADDRMAP6 /" \
	 -e "s/ DDRC_ADDRMAP7\(0\), 0x0f0f / DDRC_ADDRMAP7\(0\), ${chnum}_VAL_DDRC_ADDRMAP7 /" \
	 -e "s/ DDRC_RFSHTMG\(0\), 0x007a0118 / DDRC_RFSHTMG\(0\), ${chnum}_VAL_DDRC_RFSHTMG /" \
	 -e "s/ DDRC_DRAMTMG14\(0\), 0x0120 / DDRC_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_DRAMTMG14 /" \
	 -e "s/ DDRC_FREQ1_RFSHTMG\(0\), 0x000c001c / DDRC_FREQ1_RFSHTMG\(0\), ${chnum}_VAL_DDRC_FREQ1_RFSHTMG /" \
	 -e "s/ DDRC_FREQ1_DRAMTMG14\(0\), 0x1d / DDRC_FREQ1_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_FREQ1_DRAMTMG14 /" \
	 -e "s/ DDRC_FREQ2_RFSHTMG\(0\), 0x00030007 / DDRC_FREQ2_RFSHTMG\(0\), ${chnum}_VAL_DDRC_FREQ2_RFSHTMG /" \
	 -e "s/ DDRC_FREQ2_DRAMTMG14\(0\), 8 / DDRC_FREQ2_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_FREQ2_DRAMTMG14 /" \
	$1
	match=1
fi
if [ "${mem}" == "4g" ] ; then
	...
	sed -E -i \
	 ...
	 -e "s/0x54012, 0x0310 /0x54012, 0x10 | (${chnum}_LPDDR4_CS << 8) /" \
	 -e "s/ DDRC_MSTR\(0\), 0xa3080020 / DDRC_MSTR\(0\), 0xa0080020 | \(${chnum}_LPDDR4_CS << 24\) /" \
	 -e "s/ DDRC_ADDRMAP0\(0\), 0x17 / DDRC_ADDRMAP0\(0\), ${chnum}_VAL_DDRC_ADDRMAP0 /" \
	 -e "s/ DDRC_ADDRMAP6\(0\), 0x07070707 / DDRC_ADDRMAP6\(0\), ${chnum}_VAL_DDRC_ADDRMAP6 /" \
	 -e "s/ DDRC_ADDRMAP7\(0\), 0x0f0f / DDRC_ADDRMAP7\(0\), ${chnum}_VAL_DDRC_ADDRMAP7 /" \
	 -e "s/ DDRC_RFSHTMG\(0\), 0x007a0118 / DDRC_RFSHTMG\(0\), ${chnum}_VAL_DDRC_RFSHTMG /" \
	 -e "s/ DDRC_DRAMTMG14\(0\), 0x0120 / DDRC_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_DRAMTMG14 /" \
...
if [ "${mem}" == "8g" ] ; then
	...
	sed -E -i \
	 ...
	 -e "s/0x54012, 0x0310 /0x54012, 0x10 | (${chnum}_LPDDR4_CS << 8) /" \
	 -e "s/ DDRC_MSTR\(0\), 0xa3080020 / DDRC_MSTR\(0\), 0xa0080020 | \(${chnum}_LPDDR4_CS << 24\) /" \
	 -e "s/ DDRC_ADDRMAP0\(0\), 0x18 / DDRC_ADDRMAP0\(0\), ${chnum}_VAL_DDRC_ADDRMAP0 /" \
	 -e "s/ DDRC_ADDRMAP6\(0\), 0x07070707 / DDRC_ADDRMAP6\(0\), ${chnum}_VAL_DDRC_ADDRMAP6 /" \
	 -e "s/ DDRC_ADDRMAP7\(0\), 0x0f07 / DDRC_ADDRMAP7\(0\), ${chnum}_VAL_DDRC_ADDRMAP7 /" \
	 -e "s/ DDRC_RFSHTMG\(0\), 0x007a017c / DDRC_RFSHTMG\(0\), ${chnum}_VAL_DDRC_RFSHTMG /" \
	 -e "s/ DDRC_DRAMTMG14\(0\), 0x0184 / DDRC_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_DRAMTMG14 /" \
	 -e "s/ DDRC_FREQ1_RFSHTMG\(0\), 0x000c0026 / DDRC_FREQ1_RFSHTMG\(0\), ${chnum}_VAL_DDRC_FREQ1_RFSHTMG /" \
	 -e "s/ DDRC_FREQ1_DRAMTMG14\(0\), 0x27 / DDRC_FREQ1_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_FREQ1_DRAMTMG14 /" \
	 -e "s/ DDRC_FREQ2_RFSHTMG\(0\), 0x0003000a / DDRC_FREQ2_RFSHTMG\(0\), ${chnum}_VAL_DDRC_FREQ2_RFSHTMG /" \
	 -e "s/ DDRC_FREQ2_DRAMTMG14\(0\), 0x0a / DDRC_FREQ2_DRAMTMG14\(0\), ${chnum}_VAL_DDRC_FREQ2_DRAMTMG14 /" \
	$1
	match=1
fi
if [ $match == 0 ] ; then
...
#stage 4
#!/bin/bash
if [ ${processor} != "8ulp" ] && [ ${chnum} != "CH1" ] ; then
	echo stage 4
	sed -E \
...
cp $1 board/ocompany/common/lpddr4_timing_${processor}.c
